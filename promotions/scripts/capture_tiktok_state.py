...
def main():
    parser = argparse.ArgumentParser(description='Capture TikTok Playwright storage state.')
    parser.add_argument('--out', default='promotions/tmp/tiktok_storage_state.json')
